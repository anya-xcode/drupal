...
class LinkReplyTest extends UnitTestCase {
  ...
  public function testRenderNullEntity(): void {
    $row = new ResultRow();
    $field = new LinkReply(['entity_type' => 'foo', 'entity field' => 'bar'], '', [], $this->createStub(AccessManagerInterface::class), $this->createStub(EntityTypeManagerInterface::class), $this->createStub(EntityRepositoryInterface::class), $this->createStub(LanguageManagerInterface::class));
